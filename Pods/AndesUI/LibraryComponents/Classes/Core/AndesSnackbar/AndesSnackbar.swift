...
@objc public class AndesSnackbar: UIView {
    ...
    @objc
    public var action: AndesSnackbarAction? {
        didSet {
            self.updateContentView()
        }
    }
    ...
    @objc public init(text: String,
                      duration: AndesSnackbarDuration = .normal,
                      type: AndesSnackbarType = .neutral) {
    ...
    // Init for the new error code variation
    @objc public init(text: String,
                      duration: AndesSnackbarDuration = .normal,
                      type: AndesSnackbarType = .neutral,
                      errorCode: String) {
