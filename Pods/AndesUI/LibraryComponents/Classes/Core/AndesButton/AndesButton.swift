 ...
 */
@objc public class AndesButton: UIControl, AndesAccessibleView {
    ...
    /// returns the current selected hierarchy
    @objc public var icon: AndesButtonIcon? {
        didSet {
            self.update()
        }
    }
    ...
    private func setup() {
        ...
        self.accessibilityManager = AndesButtonAccessibilityManager(view: self)
    }
