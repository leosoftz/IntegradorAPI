...
@objc public class AndesCard: UIView, AndesAccessibleView {
    ...
    var isActionCard: Bool { onCardActionPressed != nil }
    ...
    private func setup() {
        ...
        self.accessibilityManager = AndesCardAccessibilityManager(view: self)
    }
    ...
    @objc public func setCardAction(handler: @escaping ((_ card: AndesCard) -> Void)) {
        self.cardAccessibilityLabel = nil
        self.onCardActionPressed = handler
        self.updateContentView()
    }

    @objc public func setCardAction(cardAccessibilityLabel: String, handler: @escaping ((_ card: AndesCard) -> Void)) {
