...
class AndesTextAreaView: AndesTextFieldAbstractView {
    @IBOutlet var textView: AndesUITextView!
    @IBOutlet var placeholderLabel: UILabel!
    @IBOutlet var helperToImageDistanceConstraint: NSLayoutConstraint!
    ...
    override func updateView() {
        ...
        if self.helperIconImageView.image == nil {
            self.helperLeadingToLabelLeading.priority = UILayoutPriority(rawValue: 1000)
            self.helperToImageDistanceConstraint.priority = UILayoutPriority(rawValue: 230)
        }
    }
