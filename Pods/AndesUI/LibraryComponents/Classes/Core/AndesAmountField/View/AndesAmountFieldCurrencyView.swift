//
//  AndesAmountFieldCurrencyView.swift
//  AndesUI
//
...
class AndesAmountFieldCurrencyView: AndesLabel {
    ...
    private func setupViews() {
        ...
        self.backgroundColor = UIColor.clear(debug: .green)
        self.update(style: self.fontStyleTitle)
        self.accessibilityIdentifier = "AMOUNT_FIELD_CURRENCY_VIEW"
