...
private extension AndesTextFieldCode {
    func setup() {
        ...
        accessibilityManager = AndesTextFieldCodeAccessibilityManager(view: self)
    }
...
// MARK: - Accessibility
extension AndesTextFieldCode: AndesAccessibleView {
    @objc override public func accessibilityActivate() -> Bool {
