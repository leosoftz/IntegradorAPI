...
class AndesDatePickerCell: UICollectionViewCell {
    ...
    func applyDefaultStyle(isWithinDisplayedMonth: Bool) {
        ...
        accessibilityHint = "Toque dos veces para cambiar".localized()
        numberLabel.textColor = isWithinDisplayedMonth ? AndesStyleSheetManager.styleSheet.textColorPrimary : AndesStyleSheetManager.styleSheet.textColorDisabled
