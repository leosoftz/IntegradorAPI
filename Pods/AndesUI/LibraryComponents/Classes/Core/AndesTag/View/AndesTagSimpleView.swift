...
class AndesTagSimpleView: AndesTagAbstractView {
    @IBOutlet var leftContentWidthConstraint: NSLayoutConstraint!
    @IBOutlet var leftContentViewContainer: UIView!
    ...
    override func updateView() {
        ...
        accessibilityManager = AndesTagAccessibilityManager(view: self)
    }
    ...
    func setupRightContent() {
        if let rightButtonImageName = config.rightButtonImageName {
            ...
            self.rightButton.isAccessibilityElement = true
