...
@objc public class AndesMessage: UIView, AndesAccessibleView {
    ...
    /// A Boolean value that indicates whether VoiceOver  title  acts as a header
    public var accessibilityTitleIsHeader = false {
        didSet {
    ...
    private func setup() {
        ...
        self.accessibilityManager = AndesMessageAccessibilityManager(view: self)
    }
